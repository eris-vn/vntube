                ...
                <div class="content">
                    <div class="banner-card pb--60 swiper rbt-dot-bottom-center banner-swiper-active swiper-cards swiper-3d swiper-initialized swiper-horizontal swiper-pointer-events">
                        <div class="swiper-wrapper" style="cursor: grab;" id="swiper-wrapper-56ee7dfb2adda776" aria-live="polite">
                            ...
                            <!-- Start Single Card  -->
                            <div class="swiper-slide swiper-slide-next" style="width: 390px; z-index: 2; transform: translate3d(calc(-390px + 7.25%), 0px, -100px) rotateZ(2deg) scale(1);" role="group" aria-label="2 / 3">
                                <div class="rbt-card variation-01 rbt-hover">
                                    <div class="rbt-card-img">
                                        <a href="course-details.html">
                                            <img src="/public/assets/images/course/course-01.jpg" alt="Card image">
                                            <div class="rbt-badge-3 bg-white">
                                                <span>-40%</span>
                                                <span>Off</span>
                                            </div>
                            ...
                            <!-- Start Single Card  -->
                            <div class="swiper-slide" style="width: 390px; z-index: 1; transform: translate3d(calc(-780px + 13%), 0px, -200px) rotateZ(4deg) scale(1);" role="group" aria-label="3 / 3">
                                <div class="rbt-card variation-01 rbt-hover">
                                    <div class="rbt-card-img">
                                        <a href="course-details.html">
